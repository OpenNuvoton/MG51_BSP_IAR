...
BIT BIT_TMP;
  ...
  __xdata  uint8_t rx_buf[64]; 
  __xdata  uint8_t tx_buf[64];
  __data  uint16_t flash_address; 
  __data  uint16_t AP_size;
  __data  uint8_t g_timer1Counter;
  __data  uint8_t count; 
  __data  uint16_t g_timer0Counter;
  __data  uint32_t g_checksum;
  __data  uint32_t g_totalchecksum;
  __data  uint8_t bI2CDataReady;
  __data  uint8_t bISPDataReady;//for ack
  __data  uint8_t g_u8SlvDataLen;
  __data  uint8_t g_timer0Over;
  __data  uint8_t g_timer1Over;
  __data  uint8_t g_progarmflag;
