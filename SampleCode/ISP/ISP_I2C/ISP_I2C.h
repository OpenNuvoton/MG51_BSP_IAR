...
extern  __xdata  uint8_t rx_buf[64]; 
extern  __xdata  uint8_t tx_buf[64];
extern  __data  uint16_t flash_address; 
extern  __data  uint16_t AP_size;
extern  __data  uint8_t g_timer1Counter;
extern  __data  uint8_t count; 
extern  __data  uint16_t g_timer0Counter;
extern  __data  uint32_t g_checksum;
extern  __data  uint32_t g_totalchecksum;
extern  __data  uint8_t bI2CDataReady;
extern  __data  uint8_t bISPDataReady;//for ack
extern  __data  uint8_t g_u8SlvDataLen;
extern  __data  uint8_t g_timer0Over;
extern  __data  uint8_t g_timer1Over;
extern  __data  uint8_t g_progarmflag;
