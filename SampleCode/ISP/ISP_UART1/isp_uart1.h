...
extern  __xdata  uint8_t uart_rcvbuf[64]; 
extern  __xdata  uint8_t uart_txbuf[64];
extern  __data  uint8_t bufhead;
...
extern  BIT bUartDataReady, g_timer0Over, g_timer1Over, g_progarmflag;
